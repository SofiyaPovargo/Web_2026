...
Страница №1 (page1.html): содержит общее описание проекта. Разместить на странице текст описания проекта, разметить абзацы, расставить закладки. Текст описания должен быть достаточно обширным, чтобы продемонстрировать работу с закладками. 
Страница №2 (page2.html): содержит две ссылки, которые должны вести на первую страницу c прокруткой к нужному месту в виде:

Оранжерея

читать сначала 
читать с последнего абзаца

Разместить в заголовке page1.html таблицу стилей с описанием стилевых правил для заголовков и абзацев

2. Добавить в проект страницу page3.html.
